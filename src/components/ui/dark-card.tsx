...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border bg-gray-800/60 text-card-foreground shadow-sm border-amber-400/20",
      className
    )}
    {...props}
  />
...
export { DarkCard, DarkCardHeader, DarkCardFooter, DarkCardTitle, DarkCardDescription, DarkCardContent }
